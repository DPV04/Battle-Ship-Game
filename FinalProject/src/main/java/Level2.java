...
//        SoundPlayer sound = new SoundPlayer();
        ...
        // Skip level selection and set level = 2 directly
        int level = 2;
        ...
        while (!validAttack) {
            ...
            if (opponentBoard.getCell(x, y) == ship_cell) { // Check for ship directly
                ...
                if (checkForSunkShip(opponentBoard, x, y)) {
                    ...
                    sound.playSound("C:\\Users\\dell\\Downloads\\goodresult-82807.wav");

                    if (getRemainingShips(opponentName) == 0) {
                        System.out.println("Congratulations! " + currentPlayerName + " wins!");
                        sound.playSound("C:\\Users\\dell\\Downloads\\victorymale-version-230553.wav"); //sound
    ...
    public static void Leader(){
        ...
        lead.addOrUpdatePlayer(player1Name,score);
        lead.addOrUpdatePlayer(player2Name,score);
